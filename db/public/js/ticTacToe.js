...
oContainer.innerHTML = '<h1>A game of Tic-Tac-Toe</h1>';
// définition de l'id
oContainer.id = 'game';

oH2.innerHTML = 'Tic Tac Toe';
oH2.className = 'game-title';

oDivGameGrid.id = 'game--grid';

oButtonRestart.innerHTML = 'Redémarrer le jeu';
oButtonRestart.id = 'restart';
oButtonRestart.className ='game--restart';


oH3.className = 'game--status';

// ajout du container à la fin de la blaise main (vide).
mainTicTacToe.appendChild(oContainer);

// Ajout au container de la balise 'h2'
oContainer.appendChild(oH2);
